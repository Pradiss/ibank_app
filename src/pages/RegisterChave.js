...
export default function RegisterChave({ navigation }) {
  ...
  return (
    <View style={{ padding: 16, flex: 1, justifyContent: "center" }}>
      ...
      <Text style={[styles.titleHome, { paddingBottom: 16 }]}>
        Escolha uma chave PIX para cadastrar
      </Text>
      <Text style={{ marginBottom: 8 }}> Usar E-mail:</Text>
      {options.email && (
        <Pressable
          onPress={() => setSelectedKey(options.email)}
          style={[
            styles.input,
            selectedKey === options.email && {
              borderColor: "#34E167",
              borderWidth: 2,
            },
          ]}
